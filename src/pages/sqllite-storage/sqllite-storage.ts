...
@IonicPage()
@Component({
  selector: 'page-sqllite-storage',
  templateUrl: 'sqllite-storage.html',
})
export class SqlliteStoragePage {
...
categorieMovie: string;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,private sqlite: 
    SQLite) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SqlliteStoragePage');
  }
